...
var tileTable =
{
  ...
  map:
  {
    ...
    "stone_bridge": ["nb", "14"],
    "wood_bridge": ["nb", "13"],
    "natural_bridge": ["nb", "13"],
    "permafrost": ["pf", "3"],
    "sand": ["sa", "7"],
    "archiveshrine": ["sh", "128"],
    "goldshrine": ["sg", "71"],
    "siegeshrine": ["ss", "131"],
    "defencepartshrine": ["sd", "68"],
    "manashrine": ["sm", "125"],
    "perceptionshrine": ["sp", "122"],
     //Additional tiles beyond the Google CSV ones:
    "claimed_earth_empire": ["cee", "10"],
    "claimed_floor_empire": ["cfe", "9"],
    "claimed_earth_p1": ["cep", "29"],
    "claimed_floor_p1": ["cfp", "28"],
    "claimed_earth_p2": ["cep", "29"],
    "claimed_floor_p2": ["cfp", "28"],
    "claimed_earth_p3": ["cep", "29"],
    "claimed_floor_p3": ["cfp", "28"],
    "claimed_earth_p4": ["cep", "29"],
    "claimed_floor_p4": ["cfp", "28"],
    "herogate": ["hg", "74"],
    "inhibitorshrine": ["si", "134"]
  },
  ...
  getMapperCsvValue: function(value)
  {
